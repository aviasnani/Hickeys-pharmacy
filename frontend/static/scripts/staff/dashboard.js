...
document
      ...
      function addMed() {
        ...
        apiPost("https://hickeys-backend-c66t793lq-aviasnanis-projects.vercel.app/add_meds", data)
          .then(response => {
            if (response.error) {
      ...
      function welcome() {
        apiGet("https://hickeys-backend-c66t793lq-aviasnanis-projects.vercel.appstaff_dashboard")
          .then(response => {
            if (response.error) {
      ...
      function deleteMed(id) {
        apiDelete("https://hickeys-backend-c66t793lq-aviasnanis-projects.vercel.app/delete_meds", { id: id })
          .then(response => {
            if (response.error) {
              console.log(`Response status was not 200: ${response.error}`);
      ...
      function searchMed() {
        ...
        apiPost("https://hickeys-backend-c66t793lq-aviasnanis-projects.vercel.app/search_meds", data)
          .then(response => {
            if (response.error) {
              console.log(`Response status was not 200: ${response.error}`);
      ...
      function saveMed(medicine) {
        ...
        apiPut("https://hickeys-backend-c66t793lq-aviasnanis-projects.vercel.app/edit_meds", updatedMed)
          .then(response =>{
            if (response.error) {
              console.log(`Response status was not 200: ${response.error}`);
            }
      ...
      // Logout function
      function logout() {
        apiGet("https://hickeys-backend-c66t793lq-aviasnanis-projects.vercel.app/staff_logout")
          .then(response => {
            if (response.error) {
              console.log(`Response status was not 200: ${response.status}`);
            }
